...
public class RutaEntreDosPuntos extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void dibujar(View view) {
        ...
        PolylineOptions polylineOptions = new PolylineOptions()
                .addAll(latLngList).clickable(true);//cuando esta en true no se puede hacer marcador encima de la recta
    ...
    public void Decode(View view) {DecodePolyline("bj~lBh}xkLYBWNKX?Ro@e@u@w@yBsC}CaEuAyBwA{Be@@aBF_@Dq@Ju@Ps@TiEiIgDcGwC|By@h@");
    }
